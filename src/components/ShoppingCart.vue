    ...
    saveShoppingCartLocal() {
      if (this.isLoggedIn) {
        ...
        if (isValid) {
          this.saveShoppingCart({
            ...
            this.addMessage({
              ...
              message: 'Your shopping List is saved successfully',
            })
            this.$router.push('/')
          })
        } else {
        ...
        this.addMessage({
          ...
          message: 'Please login to save your List',
        })
      }
    },
    checkout() {
      if (this.isLoggedIn) {
        ...
        if (isValid) {
          this.saveToTransaction({
            ...
            this.addMessage({
              messageClass: 'success',
              message: 'Your List has been successfully saved!',
            })
            this.saveShoppingCart({
              cartItemList: [],
              uid: this.currentUser.uid,
        ...
        this.addMessage({
          messageClass: 'warning',
          message: 'Please login to View your List',
        })
      }
    },
  },
