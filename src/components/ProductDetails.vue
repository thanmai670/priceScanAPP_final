...
<div class="container">
  <div class="col-md-12">
    ...
    <div v-else class="card">
      ...
      <div class="ratings">
        ...
        <!-- <p class="pull-right">
          <button @click="addItem" :disabled="item.quantity === 0" class="btn btn-dark">
                            Add to list
                        </button>
        </p> -->
  ...
  <div class="row" v-if="!isProductLoading">
    <app-product-item v-for="prod in products" :item="prod" :key="prod.id" :displayList="true"></app-product-item>
  </div>
</div>
</div>
